  ...
  return (
    <div className="min-vh-100" style={{ background: '#f0f0f0' }}>
      ...
      <div style={{ position: 'relative', overflow: 'hidden', height: '110px' }}>
        ...
        <div className="position-absolute top-0 end-0 h-100 d-flex align-items-center pe-4 gap-3">
          <Button
          ...
          <div
              ...
              style={{width: 44, height: 44, background: 'rgba(255,255,255,0.3)', fontSize: 16}}
          >
            {initials}
          </div>
        </div>
      ...
      <Container className="py-4">
        <div className="bg-white rounded-4 p-4 shadow-sm">
          ...
          <Row className="align-items-center mb-4">
            <Col>
              <h1 className="fs-3 fw-semibold mb-0">Timesheets</h1>
            </Col>
            <Col xs="auto">
              <Button
          ...
          {/* Rows */}
          {!loading && !error && filteredTimesheets.map((ts) => (
            <Row
              key={ts.timesheetID}
