  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://localhost:8000/api/auth/reset-password/", {
        ...
        body: JSON.stringify({ supabase_token: token, password }),
      });
      ...
      <div className="row g-0 h-100">
        ...
        >
          ...
          >
            {!done ? (
              <>
                <h2 className="text-white fw-bold mb-2">Choose a new password</h2>
              ...
              <>
                <h2 className="text-white fw-bold mb-2">Password updated</h2>
                <p className="text-white mb-4" style={{ opacity: 0.85, fontSize: "0.9rem" }}>
